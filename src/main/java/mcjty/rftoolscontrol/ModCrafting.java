...
public class ModCrafting {
    ...
    public static void init() {
        ...
        GameRegistry.addRecipe(new ItemStack(ModItems.advancedNetworkCardItem), "rer", "EnE", "rer", 'n', ModItems.networkCardItem, 'E', Items.EMERALD, 'r', Items.REDSTONE, 'e', Items.ENDER_PEARL);
