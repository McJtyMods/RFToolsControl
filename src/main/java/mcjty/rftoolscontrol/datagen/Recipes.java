...
public class Recipes extends BaseRecipeProvider {
    ...
    protected void registerRecipes(Consumer<IFinishedRecipe> consumer) {
        build(consumer, ShapedRecipeBuilder.shapedRecipe(ProcessorSetup.ADVANCED_NETWORK_CARD.get())
                        ...
                        .addCriterion("network_card", InventoryChangeTrigger.Instance.forItems(ProcessorSetup.NETWORK_CARD.get())),
                "ror", "eMe", "ror");
        ...
        build(consumer, ShapedRecipeBuilder.shapedRecipe(mcjty.rftoolscontrol.modules.various.VariousSetup.CONSOLE_MODULE.get())
                        ...
                        .addCriterion("cardbase", InventoryChangeTrigger.Instance.forItems(mcjty.rftoolscontrol.modules.various.VariousSetup.CARD_BASE.get())),
                "PMP", "rir", "PzP");
        ...
        build(consumer, ShapedRecipeBuilder.shapedRecipe(ProcessorSetup.CPU_CORE_1000.get())
                        ...
                        .addCriterion("core500", InventoryChangeTrigger.Instance.forItems(ProcessorSetup.CPU_CORE_500.get())),
                "rdr", "eMe", "rdr");
        build(consumer, ShapedRecipeBuilder.shapedRecipe(ProcessorSetup.CPU_CORE_2000.get())
                        .key('M', ProcessorSetup.CPU_CORE_1000.get())
                        .addCriterion("core1000", InventoryChangeTrigger.Instance.forItems(ProcessorSetup.CPU_CORE_1000.get())),
                "rsr", "sMs", "rsr");
