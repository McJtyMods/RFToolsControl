...
public class VectorArtModuleItem extends Item implements IModuleProvider {
...
//        super("vectorart_module");
    ...
    public void addInformation(ItemStack itemStack, @Nullable World world, List<ITextComponent> list, ITooltipFlag flagIn) {
        ...
        list.add(new StringTextComponent(TextFormatting.GREEN + "Uses " + ConfigSetup.VECTORARTMODULE_RFPERTICK.get() + " RF/tick"));
