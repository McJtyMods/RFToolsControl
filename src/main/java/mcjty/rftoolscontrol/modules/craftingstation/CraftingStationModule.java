...
public class CraftingStationModule implements IModule {
    ...
    public static final RegistryObject<Item> CRAFTING_STATION_ITEM = ITEMS.register("craftingstation", tab(() -> new BlockItem(CRAFTING_STATION.get(), Registration.createStandardProperties())));
